describe('Seo metadata', () => {
  describe('Verify SEO Metadata', () => {
    ...
    it('should render SEO metadata on portfolio page', () => {
      cy.visit('/portfolio')

      // The portfolio page should have a page title
      cy.title().should('not.be.empty')

      // The portfolio page should also contain a meta description for SEO
      cy.get('head meta[name="description"]').invoke('attr', 'content').should('not.be.empty')
    })
  })
})
